...
const TermsOfService: React.FC = () => {
  return (
      <section id="terms-of-service" className="w-full py-16 max-sm:py-10">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-medium text-body mt-8 text-gray-900">
            Welcome to Cirql! These Terms of Service ("Terms") govern your use of
            our services, software, and website ("Services"). By accessing or
            using Cirql, you agree to be bound by these Terms. If you do not agree
          ...
          <ol className="list-decimal list-inside mt-8 space-y-6 text-gray-900">
            ...
            <li>
              <h4 className="h4-bold text-[1.25rem] font-bold">6. Use of Services</h4>
              <p className="text-medium text-body mt-2">
            ...
            <li>
              ...
              <p className="text-medium text-body mt-2">
                ...
                functionality are and will remain the exclusive property of Cirql
            ...
            <li>
              <h4 className="h4-bold text-[1.25rem] font-bold">12. Indemnification</h4>
              <p className="text-medium text-body mt-2">
            ...
            <li>
              <h4 className="h4-bold text-[1.25rem] font-bold">13. Governing Law</h4>
              <p className="text-medium text-body mt-2">
            ...
            <li>
              ...
              <p className="text-medium text-body mt-2">
                ...
                our sole discretion. By continuing to access or use our Services
